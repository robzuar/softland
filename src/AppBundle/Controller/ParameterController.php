...
class ParameterController extends CrudController
{
    ...
    const ENTITY_TYPE = "ParameterFilterType";
    const ENTITY_NAMESPACE = "AppBundle\\Entity\\Parameter";
    const ENTITY_CONTROLLER= "AppBundle\\Controler\\ParameterController";
    const TYPE_NAMESPACE = "AppBundle\\Form\\ParameterType";
    const TYPE_NAMESPACE_FILTER = "AppBundle\\Form\\ParameterFilterType";
    const SINGULAR_NAME = "Parametro de Sistema";
    const PLURAL_NAME = "Parametros del Sistema";
